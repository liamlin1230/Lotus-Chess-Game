...
public class Game implements Runnable, ActionListener {
	...
	private final Boolean _isFinch;
	 ...
	 */
	public Game(int players, boolean isFinch) {
	...
	/**
	 * A method that checks if the run argument included a finch
	 * 
	 * @param flag
	 *            the value of the argument passed in
	 * @throws AWTException
	 *             an exception needed due to Robots class
	 */
	private void useFinch(boolean flag) throws AWTException {
		if (flag == true) {
			Timer t = new Timer(100, new MouseClass(_finch));
			t.start();
		}
	}
